...
def main():
    ...
    **Supported formats:** JPG, JPEG, PNG
    ...
    if uploaded_file is not None:
        ...
        st.markdown("""
        This tool automatically detects rectangular regions that might be license plates based on:
        - **Aspect ratio** (typical license plate proportions)
        - **Size constraints** (reasonable plate dimensions)
        - **Edge detection** (high contrast rectangular regions)
        - **Text-like patterns** (regions likely to contain text)
        
        The detected regions are then blurred to protect privacy while keeping the rest of the image clear.
        """)
